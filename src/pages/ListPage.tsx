  ...
  return (
    <div className="w-[90%] mx-auto">
      ...
      <div className="flex justify-center  items-center  bg-white mt-12">
        <div className="flex flex-row gap-10 flex-wrap-reverse justify-center items-center max-w-7xl w-full px-6">
          {/* Left Content */}
          <div className="flex flex-col justify-start items-start gap-8 max-w-lg">
            <h1 className="font-poppins text-[40px] leading-[60px] font-semibold text-black">
          ...
          {/* Right Content */}
          <div className="bg-backGroundGradient  rounded-full  flex justify-center items-center">
            <img src={giftpic} alt="Gift Picture" className="max-w-[400px]" />
          </div>
        </div>
      </div>
    </div>
